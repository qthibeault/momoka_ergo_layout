...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
        ...
        _______,  KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, _______,                                        _______, _______, _______,  _______, _______, _______,
        MO(_FN2), KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, _______,                                        KC_AMPR, _______, RGB_RMOD, RGB_MOD, RGB_TOG, MO(_FN2),
